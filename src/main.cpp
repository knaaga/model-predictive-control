    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Preprocessing
          // Coordinate transformation - Convert waypoints coordinates to the cars coordinates.
          size_t n_waypoints = ptsx.size();
          auto ptsx_trans = Eigen::VectorXd(n_waypoints);
          auto ptsy_trans = Eigen::VectorXd(n_waypoints);
          ...
          // State after the actuator delay
          ...
          // State vector to pass into the MPC solver
